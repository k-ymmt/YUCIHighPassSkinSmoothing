...
+ (CIColorKernel *)filterKernel {
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        NSString *kernelString = [[NSString alloc] initWithContentsOfURL:[SWIFTPM_MODULE_BUNDLE URLForResource:NSStringFromClass([YUCIHighPass class]) withExtension:@"cikernel"] encoding:NSUTF8StringEncoding error:nil];
